<?php
    ...
    if ($button)
    {
        ...
        $myDNS->Assign2Object(array('name', 'zonetype', 'masterdns',
    ...
    $time_array = array($tl->get('seconds'),$tl->get('minutes'),$tl->get('hours'),$tl->get('days'),$tl->get('weeks'),$tl->get('months'));
        ...
        <table width="680" class="tbl_global">
            ...
            <tr>
                ...
                <td>
                    <select name="zonetype">
                        <?php
                            foreach (array('Master', 'Slave', 'Dummy') as $zone_type)
                            {
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="serialautomatic" value="true" class="checkbox"<?php if (isTrue($myDNS->serialautomatic)) echo ' checked="checked"' ?> /> <?php echo $tl->get("Automatic")?>
                </td>
...
<?php if ($mode == 'update') { ?>
            <tr>
                ...
                <td><?php echo count($myDNS->records) ?>&nbsp;&nbsp;&nbsp;<a href="dns_records.php?dnsid=<?php echo $myDNS->id ?>" class="dns_link"><?php echo $tl->get("Edit") ?></a></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
