<?php
    ...
    { // New Site
        ...
        if ($templateid)
        {
            ...
            foreach (array('name', 'maxquota', 'maxuserquota', 'maxaddr',
    ...
    if ($button)
    {
        ...
        $mySite->Assign2Object(array('id', 'name', 'domainname',
    ...
    <div class="menu2">
        <table width="680" class="tbl_global">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" value="<?php echo $mySite->name ?>" maxlength="100" size="50" class="textfield"<?php if ($mode == 'update') echo ' readonly="readonly"' ?> />
                </td>
            ...
            <tr>
                ...
                <td>
                    <textarea name="domainname" cols="43" rows="4" class="textfield"><?php foreach ($mySite->myDomains->domainnames as $elem) echo "$elem\n" ?></textarea>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxquota" class="checkbox" value="-1"<?php if ($mySite->maxquota < 0) echo ' checked="checked"' ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxuserquota" class="checkbox" value="-1"<?php if ($mySite->maxuserquota < 0) echo ' checked="checked"' ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxaddr" class="checkbox" value="-1"<?php if ($mySite->maxaddr < 0) echo ' checked="checked"' ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxaliases" class="checkbox" value="-1"<?php if ($mySite->maxaliases < 0) echo ' checked="checked"' ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table width="200">
                        <tr>
                            <td>
                                <input type="checkbox" name="viruscheckin" value="true" class="checkbox"<?php if (isTrue($mySite->viruscheckin)) echo 'checked="checked"' ?> /> <?php echo $tl->get('Incoming') ?>
                            </td>
                            <td>
                                <input type="checkbox" name="viruscheckout" value="true" class="checkbox"<?php if (isTrue($mySite->viruscheckout)) echo 'checked="checked"' ?> /> <?php echo $tl->get('Outgoing') ?>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table width="200">
                        <tr>
                            <td>
                                <input type="checkbox" name="spamcheckin" value="true" class="checkbox"<?php if (isTrue($mySite->spamcheckin)) echo 'checked="checked"' ?> /> <?php echo $tl->get('Incoming') ?>
                            </td>
                            <td>
                                <input type="checkbox" name="spamcheckout" value="true" class="checkbox"<?php if (isTrue($mySite->spamcheckout)) echo 'checked="checked"' ?> /> <?php echo $tl->get('Outgoing') ?>
                            </td>
                        </tr>                                       
                    </table>
                </td>
...
<th><?php echo $tl->get("Spam Score Trigger")?></th>
	<td>
	<?php echo $tl->get("Spam Score")?>: <input type="text" name="spamscore" value="<?php echo $mySite->spamscore?>" maxlength="3" size="3" class="textfield" />
	<?php echo $tl->get("High Spam Score")?>: <input type="text" name="highspamscore" value="<?php echo $mySite->highspamscore?>" maxlength="3" size="3" class="textfield" />
	</td>
                    ...
                    <table width="410">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="sitestate" class="radiobutton" value="default"<?php if ($mySite->sitestate == "default") echo ' checked="checked"' ?> /> <?php echo $tl->get("Active") ?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="sitestate" class="radiobutton" value="locked"<?php if ($mySite->sitestate == "locked") echo ' checked="checked"' ?> /> <?php echo $tl->get("Locked") ?>
                            </td>
                            <td style="width: 210px;">
                                <input type="radio" name="sitestate" class="radiobutton" value="lockedbounce"<?php if ($mySite->sitestate == "lockedbounce") echo ' checked="checked"' ?> /> <?php echo $tl->get("Locked & Bounce") ?>
                            </td>
                        </tr>
                    </table>
                </td>
